...
import { ButtonZ } from "@/components/ui/button";
        ...
        <div>
            ...
            <section className="border-b-2 border-gray-900">
                ...
                <div className="-mt-12 flex justify-between items-end px-6">
                    <img src={user.avatar} alt={user.name} className="size-24 rounded-full object-cover" />
                    <div className="w-32">
                        {isMe &&
                            <Link href={`/${user.slug}/edit`}>
                                <ButtonZ label="Editar Perfil" size={2} />
                            </Link>
                        }
                        {!isMe && 
                            <ButtonZ label="Seguir" size={2} />
                        }
                    </div>
                </div>
                <div className="px-6 mt-4">
                    ...
                    <div className="my-5 flex gap-6">
                        <div className="text-xl text-gray-500"><span className="text-white">1</span> Seguindo</div>
                        <div className="text-xl text-gray-500"><span className="text-white">2</span> Sequidores</div>
                    </div>
                </div>
            </section>
            <ProfileFeed />
